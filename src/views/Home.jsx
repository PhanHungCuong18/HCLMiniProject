...
const Home = () => {
    ...
    const getData = async () => {
        try {
            ...
            const requestUrl=`http://localhost:8093/employees/page/${paramString}`;
            const response = await axios.get(requestUrl).then((res)=>{return res.data});
            const data =response;
            setEmployee(data);
    ...
    const find = () => {
        ...
        axios.get("http://localhost:8094/search", {
            params: {
